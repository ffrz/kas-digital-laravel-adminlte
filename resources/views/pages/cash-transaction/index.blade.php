...
@section('right-menu')
  <li class="nav-item">
    <a class="btn btn-sm btn-primary" href="{{ url('cash-transaction/edit/0') }}" title="Baru">
      <i class="fa fa-plus"></i>
    </a>
    <a class="btn btn-sm btn-default" href="{{ url('cash-transaction/transfer') }}" title="Transfer">
