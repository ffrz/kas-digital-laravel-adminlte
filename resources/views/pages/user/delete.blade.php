...
@section('content')
  <div class="card card-light">
    <form class="form-horizontal quick-form" method="POST" action="{{ url('user/delete/' . $user->id) }}">
      @csrf
      <div class="card-body">
      ...
      <div class="card-footer">
        <div>
          <a href="{{ url('user') }}" class="btn btn-default mr-2"><i class="fas fa-arrow-left mr-1"></i>
            Kembali</a>
